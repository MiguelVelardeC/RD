...
public partial class UserControls_ContextualHelp : System.Web.UI.UserControl
{
    ...
    private void BuildMainCss()
    {
        ...
        styleMain.Append("  overflow: hidden;\n");
        styleMain.Append("  background-color: #FFF;\n");
        styleMain.Append("}\n");
        styleMain.Append(".CHelpMainCss_" + this.ID + " div\n");
        styleMain.Append("{\n");
        styleMain.Append("  overflow: hidden;\n");
        styleMain.Append("}\n");
        styleMain.Append(".CHelpMainCss_" + this.ID + " iframe\n");
        styleMain.Append("{\n");
        styleMain.Append("  overflow-x: hidden;\n");
        styleMain.Append("}\n");
    ...
    private string RegisterPopUpLink()
    {
        ...
        switch (Mode)
        {
            case eMode.Ajax:
                {
                    popUpLink = string.Format("<a class='miniHelp' style='float:right;' {0} id='modal_{1}'>", "href='#CHelpDialog_" + this.ID + "'", this.ID);
                    break;
                }
            case eMode.Window:
                {

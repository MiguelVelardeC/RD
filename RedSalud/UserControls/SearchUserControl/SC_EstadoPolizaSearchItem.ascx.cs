...
public partial class UserControls_SearchUserControl_SC_EstadoPolizaSearchItem : AbstractSearchItem
{
    ...
    public override string GetValue()
    {
        if (string.IsNullOrEmpty(CSearch_Item_AspnetControl.Text.Trim()))
            return "";
        return "@" + this.SearchColumnKey + " " + (CSearch_Item_AspnetControl.SelectedValue == "ACTIVO" ? 1 : 0);
    }

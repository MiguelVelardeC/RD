...
public partial class Siniestralidad_ReporteSiniestralidadClienteDetail : System.Web.UI.Page
{
    ...
    private void ProcessSessionParameters()
    {
        ...
        if (Session["TipoPoliza"] != null && !string.IsNullOrEmpty(Session["TipoPoliza"].ToString()))
        {
            try
            {
                ...
                //'<%# Eval("ClienteId") +";"0
                //+ Eval("CodigoCliente") + ";"1
                //+ Eval("NombreJuridico") + ";"2
                //+ Eval("Nit") + ";"3
                //+ Eval("Direccion") %> '4
                //+ dfecini + ";" 5
                //+ dfecfin;6

                ClienteIdHF.Value = arregloDeSubCadenas[0].ToString();
                idCliente = int.Parse(arregloDeSubCadenas[0].ToString());
                Codigo.Text = arregloDeSubCadenas[1].ToString(); 
                NombreCliente.Text = arregloDeSubCadenas[2].ToString();
                NIT.Text = arregloDeSubCadenas[3].ToString();
                Direccion.Text = arregloDeSubCadenas[4].ToString();
                
                string fIniSearch = arregloDeSubCadenas[5].ToString();
                string fFinSearch = arregloDeSubCadenas[6].ToString();
                FechaIni.Text = fIniSearch != "" ? (String.Format("{0:dd/MM/yyyy}", DateTime.Parse(fIniSearch))) : "";
                FechaFin.Text = fFinSearch != "" ? (String.Format("{0:dd/MM/yyyy}", DateTime.Parse(fFinSearch))) : "";
    ...
    private void BindGrid()
    {
        try {
            ...
            List<SiniestralidadClienteDetail> _cache = new List<SiniestralidadClienteDetail>();
            ...
            try
            {
                ...
                string fechaIni = FechaIni.Text != "" ? (String.Format("{0:yyyy/MM/dd}", DateTime.Parse(FechaIni.Text))) : "";
                string fechaFin = FechaFin.Text != "" ? (String.Format("{0:yyyy/MM/dd}", DateTime.Parse(FechaFin.Text))) : "";
                int _totalRows = SiniestralidadClienteBLL.GetReporteSiniestralidadDetail(_cache, idCliente, fechaIni, fechaFin);
    ...
    private void ExportarExcel()
    {
        try
        {
            ...
            RadGrid1.ID = "ReporteSiniestralidadClienteDetailGrid";
            ...
            boundColumn.DataField = "Prestacion";
            ...
            boundColumn.DataType = typeof(System.Decimal);
            RadGrid1.MasterTableView.Columns.Add(boundColumn);
            boundColumn.DataField = "MontoCoPago";
            ...
            boundColumn.DataType = typeof(System.Decimal);
            RadGrid1.MasterTableView.Columns.Add(boundColumn);
            boundColumn.DataField = "ConsultasAno";
            ...
            int _totalRows = SiniestralidadClienteBLL.GetReporteSiniestralidadDetail(_cache, Convert.ToInt32( ClienteIdHF.Value), fechaIni, fechaFin);
            ...
            RadGrid1.ExportSettings.ExportOnlyData = true;
            RadGrid1.ExportSettings.FileName = "ReporteDeSiniestralidadCliente";

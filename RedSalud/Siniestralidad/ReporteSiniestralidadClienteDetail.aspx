<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ReporteSiniestralidadClienteDetail.aspx.cs" Inherits="Siniestralidad_ReporteSiniestralidadClienteDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="Server">
      ...
      <div class="frame">
         <div class="columnContent">
            <div class="contentMenu noPrint">
               <asp:HyperLink ID="returnHL" NavigateUrl="~/Siniestralidad/ReporteSiniestralidadCliente.aspx" runat="server"
                  Text="VOLVER" />
   ...
   <table id="ReporteSiniestralidadxPoliza" cellpadding="0" cellspacing="8" runat="server">
       <tr>
         ...
         <td class="auto-style4">
             <asp:Literal ID="Codigo" runat="server"></asp:Literal>            
         </td>
       ...
       <tr>
         ...
         <td class="auto-style4">
            <asp:Literal ID="NIT" runat="server"></asp:Literal>
         </td>
   ...
   <telerik:RadGrid ID="ReporteSiniestralidadDetailGrid" runat="server"
      ...
      <MasterTableView Width="100%">
         <NoRecordsTemplate>
            <div style="text-align: center;">No hay Reportes de Siniestralidad registrados para el Cliente seleccionado</div>
         </NoRecordsTemplate>
         ...
         <Columns>
            <telerik:GridBoundColumn DataField="Prestacion" Visible="true"
            ...
            <telerik:GridNumericColumn DataField="MontoTope" Visible="true" HeaderStyle-ForeColor="Black" HeaderStyle-Font-Bold="true"
               HeaderText="Monto Tope" DataType="System.Decimal" DataFormatString="{0:#,##0.00}" />
            <telerik:GridNumericColumn DataField="MontoAcumulado" Visible="true" HeaderStyle-ForeColor="Black" HeaderStyle-Font-Bold="true"
               HeaderText="Monto Acumulado" DataType="System.Decimal" DataFormatString="{0:#,##0.00}" />
            <telerik:GridNumericColumn DataField="MontoCoPago" Visible="true" HeaderStyle-ForeColor="Black" HeaderStyle-Font-Bold="true"
               HeaderText="Co-Pago Acumulado" DataType="System.Decimal" DataFormatString="{0:#,##0.00}" />
            <telerik:GridBoundColumn DataField="ConsultasAno" Visible="true" HeaderStyle-ForeColor="Black" HeaderStyle-Font-Bold="true"

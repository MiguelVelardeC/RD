<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CartaGarantiaImprimir.aspx.cs" Inherits="SOAT_CartaGarantiaImprimir" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            <div class="columnHead noPrint">
                <span class="title">Reporte Siniestro</span>
            </div>

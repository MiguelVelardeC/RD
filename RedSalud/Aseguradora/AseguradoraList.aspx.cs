...
public partial class Aseguradora_AseguradoraList : System.Web.UI.Page
{
    ...
    protected void AseguradoraGV_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "EditRecord")
        {
            ...
            Response.Redirect("~/Aseguradora/AseguradoraDetails.aspx");

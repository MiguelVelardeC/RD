<%@ Page Title="Asegudadora" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AseguradoraList.aspx.cs" Inherits="Aseguradora_AseguradoraList" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            <div class="columnHead">
                <span class="title">Lista de Aseguradoras</span>
            </div>
            <div class="columnContent">
                <div class="contentMenu">
                    <asp:HyperLink ID="HyperLink1" runat="server" Text="Crear Cliente"
                        NavigateUrl="~/Aseguradora/AseguradoraDetails.aspx">
                    </asp:HyperLink>
                </div>

                <div class="gridContainer">
                    <asp:GridView ID="AseguradoraGV" runat="server"
                        DataSourceID="AseguradoraODS"
                        OnRowCommand="AseguradoraGV_RowCommand"
                        CssClass="grid" Width="100%" AutoGenerateColumns="false">
                        <EmptyDataTemplate>
                            <asp:Label ID="Label1" Text="No existen Aseguradoras" runat="server" />
                        </EmptyDataTemplate>
                        <Columns>
                    ...
                    <asp:ObjectDataSource ID="AseguradoraODS" runat="server"
                        ...
                        OnSelected="AseguradoraODS_Selected"></asp:ObjectDataSource>
                </div>
            </div>
        </div>
    </div>

...
namespace Artexacta.App.Utilities.Text
{
    ...
    public class TextUtilities
    {
        ...
        public static string MakeForDisplay(int ID, params string[] Names)
        {
            string nameComplete = "";
            ...
            return nameComplete + " (" + ID.ToString("00000") + ")";
        }
        public static int MeasureStringHeight(string text, int maxWidth, Font fontFamily)
        {
            Size size = TextRenderer.MeasureText(text, fontFamily, new Size(maxWidth, 0), TextFormatFlags.WordBreak);

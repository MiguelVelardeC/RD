...
namespace Artexacta.App.ViewStateSql.BLL
{
    ...
    public class ViewStateSqlBLL
    {
        ...
        {
            ViewStateSql obj = new ViewStateSql(theId, theValue, 
                Artexacta.App.Configuration.Configuration.GetViewStateExpirationForDataBase());
            return obj;
        }
        ...
        public static void ExpireViewState()
        {
            ...
            {
                log.Error("There wass an error expiring the viewstate: ", q);
            }
        }
    }
}
...
namespace Artexacta.APP.SavedSearch.BLL
{
    ...
    public class SavedSearchBLL
    {
        ...
        public static bool Delete(SavedSearch obj)
        {
            ...
            SearchSavedDSTableAdapters.GetSavedSearchTableAdapter adapter =
                new SearchSavedDSTableAdapters.GetSavedSearchTableAdapter();
        ...
        public static List<SavedSearch> GetSavedSearch(string searchId, int userId)
        {
            ...
            try
            {
                SearchSavedDS.GetSavedSearchDataTable table = adapter.GetSavedSearch(searchId, userId);

                if (table != null && table.Rows.Count > 0)
                {
                    foreach (SearchSavedDS.GetSavedSearchRow row in table.Rows)
                    {
        ...
        public static List<SavedSearch> GetSavedSearch(string searchId, int userId, string name)
        {
            ...
            try
            {
                SearchSavedDS.GetSavedSearchDataTable table = 
        ...
        private static SavedSearch FillRecord ( SearchSavedDS.GetSavedSearchRow row )
        {

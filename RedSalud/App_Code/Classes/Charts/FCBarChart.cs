...
namespace Artexacta.App.Chart
{
    ...
    /// </summary>
    [Serializable]
    public class FCBarChart : FusionChart
    {
        ...
        public FCBarChart()
        {
            ...
            this._xmlSchemaFile = "~/FusionCharts/Schema/MultiSeriesBar2DSchema.xsd";
        }

        protected override void PrepareConfigurationDataForChart()
        {
            // Setting filename for exporting
            ExportFileName = "BarChart";
        }
        ...
        /// <summary>
        /// It does nothing when there is only ONE series
        /// </summary>
        /// <param name="dts"></param>
        /// <returns></returns>

<%@ Page Title="Historial" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="HistorialPrintDESG.aspx.cs" Inherits="CasoMedico_HistorialDESG" %>
    ...
    <div class="oneColumn" ng-app>
        <div class="frame">
            <div class="columnContent">
                        ...
                        <tr>
                            <th>
                                <div class="columnHead">
                                    ...
                                    <span class="title" style="text-align: left; float: left; width: 70%; margin: 30px 0 10px; font-size: 20px!important; box-sizing: border-box; padding-left: 50px;">Historia Clinica</span>
                            ...
                            <td>
                                <asp:Panel ID="infoPaciente" CssClass="fieldset" runat="server">
                                    ...
                                    <div style="float: right;">
                                        <RedSalud:FotoPaciente runat="server" ID="FotoPaciente" Visible="false" />
                                    </div>
                                    <div class="clear"></div>
                                </asp:Panel>
                                <br />
                                ...
                                <asp:ObjectDataSource ID="HistorialODS" runat="server"
                                    ...
                                    SelectMethod="HistorialPacienteDESG"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:ControlParameter ControlID="ClienteIdDESG" Name="ClienteIdDESG" PropertyName="Value" Type="Int32" />
                                    </SelectParameters>
                                </asp:ObjectDataSource>
                            </td>
                        </tr>
                ...
                <asp:HiddenField ID="ClienteIdDESG" runat="server" />
            </div>
        </div>
    </div>

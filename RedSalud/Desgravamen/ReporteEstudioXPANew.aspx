<%@ Page Title="Panel de Control de Desgravamen" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteEstudioXPANew.aspx.cs" Inherits="Desgravamen_ReporteEstudioXPANew" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            ...
            <div class="columnContent">
                ...
                <asp:LinkButton ID="GenerarReportePlazaProve" runat="server" CssClass="button"
                    OnClick="GenerarReportePlazaProve_Click">
                    <span>Generar Reporte Plaza Prove</span>
                </asp:LinkButton>

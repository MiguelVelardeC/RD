<%@ Page Title="Lista de Propuesto Asegurado" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PropuestoAseguradoLista.aspx.cs" Inherits="Desgravamen_PropuestoAseguradoLista" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            <div class="columnHead">
                <span id="ListPropuestoAseguradoTitle" runat="server" class="title">Lista de Propuestos Asegurados</span>
            </div>
            <div class="columnContent">
                <div class="contentMenu">
                    <asp:LinkButton runat="server" NavigateUrl="~/Desgravamen/PropuestoAsegurado.aspx" Text="Agregar Propuesto Asegurado"  ID="LinkPropuestoAsegurado" OnClick="LinkPropuestoAsegurado_Click"></asp:LinkButton>
                </div>
                ...
                <asp:Panel id="EjecutivoPanel" runat="server" Style="display:inline;" DefaultButton="botonEjecutivo">
                ESTADO: 
                <asp:DropDownList ID="enlaceRapidoBusqueda" runat="server" 
                 ...
                 CITA:
                <telerik:RadNumericTextBox id="citaIdEjecutivo" MinValue="0" NumberFormat-DecimalDigits="0" EmptyMessage="Numero de Cita" NumberFormat-GroupSeparator="" runat="server" width="150px" Style=""/>
                PROPUESTO ASEGURADO:
                <telerik:RadTextBox ID="propuestoAseguradoEjecutivo" runat="server" EmptyMessage="Nombre Del Propuesto Asegurado" Width="250px" ></telerik:RadTextBox>                                           
                    <asp:LinkButton ID="btnSearchEjecutivo" runat="server" CssClass="button"
                                    OnClick="btnSearchEjecutivo_Click">
                        <span>BUSCAR</span>
                    </asp:LinkButton>  
                    
                    <asp:Button id="botonEjecutivo" Text="" Style="display:none;" runat="server" OnClick="btnSearchEjecutivo_Click" />
                </asp:Panel>
                ...
                <asp:Panel id="AdminPanel" runat="server" CssClass="PanelAdmin" style="font-size: 12px;" DefaultButton="boton"> 
                    ...
                    ESTADO:
                    <asp:DropDownList ID="enlaceRapidoBusqueda2" runat="server" 
                        AutoPostBack="false" 
                        OnSelectedIndexChanged="enlaceRapidoBusqueda_SelectedIndexChanged"
                    ...
                    <MasterTableView DataKeyNames="PropuestoAseguradoId" ExpandCollapseColumn-Display="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="DeletePA" runat="server" CssClass="BotonDelete"
                                        ...
                                        CommandName="Delete"
                                        CommandArgument='<%# Eval("CitaDesgravamenId").ToString() + "-" + Eval("PropuestoAseguradoId").ToString() %>'
                            ...
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="VerPA" runat="server"
                                        ...
                                        CommandName="VerPA"
                                        CommandArgument='<%# Eval("PropuestoAseguradoId") %>'
                            ...
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30">
                                <ItemTemplate>
                                    <asp:ImageButton ID="AprobarPA" runat="server"
                                        ToolTip="Aprobar"
                                        CommandName="AprobarPA"
                                        CommandArgument='<%# Eval("CitaDesgravamenId") %>'
                                        ImageUrl="~/Images/Neutral/update.jpg" Width="18px" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="CrearCita" runat="server"
                                        Visible='<%# Convert.ToInt32(Eval("CitaDesgravamenId")) != 0 %>'
                                        CommandArgument='<%# Eval("CitaDesgravamenId") %>'
                                        CommandName="Cita"
                                        Tooltip='<%#  string.IsNullOrEmpty(Eval("NombreMedico").ToString()) ? "Cita" : "Cita (" + Eval("NombreMedico") + ")" %>'
                                        ImageUrl="~/Images/Neutral/historialMedico.png" Width="18px" />
                                    <asp:Label ID="nroCitaLabel" runat="server" Text='<%# "(" + Eval("CitaDesgravamenId") + ")" %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ProgramacionCita" runat="server"
                                        ToolTip="Programar"
                                        CommandName="ProgramacionCita"
                                        Visible='<%# Convert.ToInt32(Eval("CitaDesgravamenId")) != 0 %>'
                                        CommandArgument='<%# Eval("CitaDesgravamenId") %>'
                                        ImageUrl="~/Images/Neutral/alert-clock-icon.png" Width="18px" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30">
                            ...
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"
                                HeaderStyle-Width="30">
                                <ItemTemplate>
                                    <asp:ImageButton ID="DescargarOrden" runat="server"
                                        ToolTip="Descargar Orden"
                                        CommandName="DescargarOrden"
                                        CommandArgument='<%# Eval("CitaDesgravamenId") %>'
                                        ImageUrl="~/Images/Neutral/pdf-icon-light.png" Width="18px" Height="18px" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridBoundColumn UniqueName="TipoProducto" DataField="TipoProductoForDisplay"
                                HeaderText="Producto" />
                            <telerik:GridBoundColumn UniqueName="NombreJuridico" DataField="NombreJuridicoForDisplay"
                                HeaderText="Cliente" />
                                                ...
                                                <asp:Repeater ID="DocumentosRepeater" runat="server" 
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="DownloadImageButton" runat="server"
                                                            ...
                                                            ToolTip='<%# "Archivo: " + Eval("Name").ToString() + " - Subido en: " + Eval("DateUploaded").ToString() %>'></asp:ImageButton>

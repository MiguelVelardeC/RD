<%@ Page Title="Reporte de Diagnóstico Presuntivo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteDiagnosticoPresuntivo.aspx.cs" Inherits="Reportes_ReporteDiagnosticoPresuntivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="Server">
    <div class="oneColumn">        
        <div class="columnHead">
            <asp:Label ID="Label1" Text="Reporte de Diagnóstico Presuntivo" runat="server" CssClass="title" />
        </div>
        ...
        <div style="margin: 0 auto; height:auto;">
            <rsweb:ReportViewer ID="RedSaludReportViewer" runat="server" Height="800px" 
                ...
                <LocalReport ReportPath="RDLC/DiagnosticoPresuntivo.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="BodyObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" 
                ...
                TypeName="VideoLlamadaDSTableAdapters.DiagnosticoPresuntivoTableAdapter">
                <SelectParameters>

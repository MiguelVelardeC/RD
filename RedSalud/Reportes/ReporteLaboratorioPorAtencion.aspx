<%@ Page Title="Reporte de Casos Medicos" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ReporteLaboratorioPorAtencion.aspx.cs" Inherits="Laboratorio_ReporteLaboratorioCompleto" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            <div class="columnHead">
                <asp:Label Text="Reporte de Examenes Complementarios" runat="server" CssClass="title" />
            </div>
                ...
                <telerik:RadGrid ID="CasoRadGrid" runat="server"
                    ...
                    <MasterTableView DataKeyNames="CodigoCaso" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed" 
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="CodigoAsegurado" DataField="CodigoAsegurado" HeaderText="CÓDIGO ASEGURADO" Visible="false" />
                            ...
                            <telerik:GridBoundColumn UniqueName="Edad" DataField="Edad" HeaderText="EDAD" Visible="false" />
                            ...
                            <telerik:GridBoundColumn UniqueName="PresionArterial" DataField="PresionArterialForDisplay" HeaderText="PRESION ARTERIAL" Visible="false" />
                            <telerik:GridBoundColumn UniqueName="Pulso" DataField="PulsoForDisplay" HeaderText="PULSO" Visible="false" />
                            ...
                            <telerik:GridBoundColumn UniqueName="EstaturaCm" DataField="EstaturaCmForDisplay" HeaderText="Estatura" Visible="false" />
                            ...
                            <telerik:GridBoundColumn UniqueName="ProveedorEstudio" DataField="ProveedorEstudioForDisplay" HeaderText="PROVEEDOR" Visible="true" />
                            <telerik:GridBoundColumn UniqueName="ParentNombre" DataField="ParentNombreForDisplay" HeaderText="TIPO ESTUDIO" Visible="true" />
                            <telerik:GridBoundColumn UniqueName="TipoEstudio" DataField="TipoEstudioForDisplay" HeaderText="ESTUDIO" Visible="true" />
                            <telerik:GridBoundColumn UniqueName="ObservacionLab" DataField="ObservacionLabForDisplay" HeaderText="OBSERVACIONES LABORATORIOS" Visible="false" />
                        </Columns>
                    </MasterTableView>
                </telerik:RadGrid>
                <asp:ObjectDataSource ID="ReporteCasoMedicoODS" runat="server"
                    TypeName="Artexacta.App.Reportes.BLL.LaboratorioBLL"
                    OldValuesParameterFormatString="original_{0}"
                    SelectMethod="SearchLaboratorioPorAtenciones"

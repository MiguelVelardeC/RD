...
public partial class Reportes_ReporteCalificacionesObtenidasMedico : System.Web.UI.Page
{
    ...
    protected void GenerarReporte_Click ( object sender, EventArgs e )
    {
        ...
        {           
            ...
            parameters[0] = new ReportParameter("MedicoId", MedicoDDL.SelectedValue);
            parameters[1] = new ReportParameter("MedicoNombre", MedicoDDL.SelectedItem.Text);

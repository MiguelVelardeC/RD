<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteOdontologia.aspx.cs" Inherits="Reportes_ReporteOdontologia" %>
    ...
    <div class="oneColumn">
        <div class="frame">
            <div class="columnHead">
                <asp:Label Text="Reporte de Odontología" runat="server" CssClass="title" />
            </div>
            <div class="columnContent">
                <asp:Panel ID="Search" runat="server">
                    ...
                    <asp:Label ID="Label6" Text="FILTRAR" runat="server" 
                        style="width: 145px;"
                        CssClass="label left" />
                    <search:SearchControl ID="SearchOdontologia" runat="server"
                    AdvancedSearchForm="~/UserControls/AdvancedSearch/RepOdontologiaAdvancedSearch.ascx"
                    DisplayHelp="true"
                    ...
                    SavedSearches="true"
                    SavedSearchesID="searchCtl_RepOdontologia"
                ...
                <telerik:RadGrid ID="OdontologiaRadGrid" runat="server"
                    DataSourceID="ReporteOdontologiaODS"
                    AllowPaging="true"
                    AllowSorting="true"
                    PageSize="20"
                    ShowFooter="True"
                    OnExcelExportCellFormatting="OdontologiaRadGrid_ExcelExportCellFormatting"
                    ...
                    <MasterTableView DataKeyNames="CodigoCaso" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="FechaCaso" DataField="FechaCreacion" HeaderText="FECHA DE REGISTRO" 
                                ItemStyle-HorizontalAlign="Left" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy}" />
                            ...
                            <telerik:GridBoundColumn UniqueName="FechaNacimiento" DataField="FechaNacimiento" HeaderText="FECHA DE NACIMIENTO" 
                                ItemStyle-HorizontalAlign="Left" DataType="System.DateTime" Visible="true"  DataFormatString="{0:dd/MM/yyyy}" />
                            <telerik:GridBoundColumn UniqueName="Edad" DataField="EdadCalculadaForDisplay" HeaderText="EDAD" 
                                ItemStyle-HorizontalAlign="Left" DataType="System.Int32" Visible="true" />
                            <%-- 
                            ...
                            <telerik:GridBoundColumn UniqueName="Prestacion" DataField="Prestacion" HeaderText="PRESTACIÓN" />
                            <telerik:GridBoundColumn UniqueName="Pieza" DataField="Pieza" HeaderText="PIEZA" />
                            ...
                            <telerik:GridBoundColumn UniqueName="FechaCreacionGasto" DataField="FechaCreacionGasto" 
                                HeaderText="FECHA REGISTRO" DataFormatString="{0:dd/MM/yyyy}" Visible="true" />
                             
                            <telerik:GridBoundColumn UniqueName="FechaGasto" DataField="FechaGasto" 
                                HeaderText="FECHA GASTO" DataFormatString="{0:dd/MM/yyyy}" />
                ...
                <asp:ObjectDataSource ID="ReporteOdontologiaODS" runat="server"
                    TypeName="Artexacta.App.Reportes.BLL.OdontologiaBLL"
                    OldValuesParameterFormatString="original_{0}"
                    SelectMethod="SearchOdontologia"
                    OnSelected="ReporteOdontologiaODS_Selected">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="SearchOdontologia" PropertyName="Sql" DbType="String" Name="where" />

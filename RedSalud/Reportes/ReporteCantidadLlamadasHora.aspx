<%@ Page Title="Reporte de Cantidad de Video Llamadas por Hora" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteCantidadLlamadasHora.aspx.cs" Inherits="Reportes_ReporteCantidadLlamadasHora" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="Server">
    <div class="oneColumn">        
        <div class="columnHead">
            <asp:Label ID="Label1" Text="Reporte de Cantidad de Video Llamadas por Hora" runat="server" CssClass="title" />
        </div>
        ...
        <div style="margin: 0 auto; height:auto;">
            <rsweb:ReportViewer ID="RedSaludReportViewer" runat="server" Height="800px" 
                ...
                <LocalReport ReportPath="RDLC/CantidadLlamadasHora.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="BodyObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" 
                ...
                TypeName="VideoLlamadaDSTableAdapters.CantidadLlamadasHoraTableAdapter">
                <SelectParameters>

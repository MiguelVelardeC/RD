...
public partial class CasoMedico_ReporteCasoMedico : System.Web.UI.Page
{
    ...
    protected void ReporteCasoMedicoODS_Selected ( object sender, ObjectDataSourceStatusEventArgs e )
    {
        ...
        {
            List<CasoMedico> casos = (List<CasoMedico>)e.ReturnValue;
            int TotalCasos = 0;
            List<string> codigosCaso = new List<string>();
            foreach (CasoMedico caso in casos)
            {

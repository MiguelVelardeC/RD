...
public partial class Reportes_ReporteAtencionesPorMes : System.Web.UI.Page
{
    ...
    protected void GenerarReporte_Click ( object sender, EventArgs e )
    {
        ...
        {           
            ...
            parameters[2] = new ReportParameter("MedicoId", MedicoDDL.SelectedValue);
            parameters[3] = new ReportParameter("MedicoNombre", MedicoDDL.SelectedItem.Text);
            ...
            parameters[6] = new ReportParameter("FechaIni", FechaIniDP.SelectedDate.Value.ToString("yyyy-MM-dd"));
            parameters[7] = new ReportParameter("FechaFin", FechaFinDP.SelectedDate.Value.ToString("yyyy-MM-dd"));

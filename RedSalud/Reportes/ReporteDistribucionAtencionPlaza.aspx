<%@ Page Title="Reporte de Distribución de Atención por Plaza" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteDistribucionAtencionPlaza.aspx.cs" Inherits="Reportes_ReporteDistribucionAtencionPlaza" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="Server">
    <div class="oneColumn">        
        <div class="columnHead">
            <asp:Label ID="Label1" Text="Reporte de Distribución de Atención por Plaza" runat="server" CssClass="title" />
        </div>
        ...
        <div style="margin: 0 auto; height:auto;">
            <rsweb:ReportViewer ID="RedSaludReportViewer" runat="server" Height="800px" 
                ...
                <LocalReport ReportPath="RDLC/DistribucionAtencionPlaza.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="BodyObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" 
                ...
                TypeName="VideoLlamadaDSTableAdapters.DistribucionAtencionPlazaTableAdapter">
                <SelectParameters>
